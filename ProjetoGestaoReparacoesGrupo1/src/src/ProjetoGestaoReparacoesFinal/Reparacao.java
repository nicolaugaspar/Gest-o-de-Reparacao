...
public class Reparacao extends Cliente{
    ...
    public Reparacao(String descricao, Cliente c, float valorSprestado, float valorPecasAplicar, String estado, double saldoRepara) {
